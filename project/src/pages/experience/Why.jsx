...
export function WhyPage() {
  ...
  const videoUrl = gumletId
    ? `https://play.gumlet.io/embed/${extractGumletId(gumletId)}`
                ...
                {FEATURES.map((f, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group flex flex-col p-4 lg:p-3.5 rounded-[20px] h-[155px] lg:h-[135px] xl:h-[140px] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md"
                      style={{
                        background:
                          "linear-gradient(135deg, rgba(40, 84, 245, 0.06), rgba(108, 59, 255, 0.05)), #FFFFFF",
                        border: "1px solid #E3E7F5",
