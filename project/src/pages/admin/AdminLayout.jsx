...
function pageTitle(pathname) {
  ...
  if (pathname.startsWith("/admin/emails/")) return "Invite Details";
  if (pathname === "/admin/emails") return "Send Invite";
  if (pathname === "/admin/grant-access") return "Grant Access";
  if (pathname === "/admin/products") return "Products";
  if (pathname.startsWith("/admin/products/")) return "Product Details";
  if (pathname.startsWith("/admin/cookies/")) return "Cookie Consent History";
  if (pathname === "/admin/cookies") return "Cookie Consents";
  return "Admin";
}
