  ...
  return (
    <div className="mx-auto max-w-2xl py-10 text-center">
      ...
      <div className="mt-10 grid gap-4 text-left md:grid-cols-2">
        <div
          className="rounded-3xl border border-[#E3EBFF] bg-gradient-to-b from-[#FCFDFF] to-[#F7FAFF] p-6 shadow-[0_12px_40px_rgba(32,76,237,0.05)] transition-all duration-[180ms] ease-out hover:-translate-y-[3px] hover:scale-[1.01] hover:shadow-[0_12px_30px_rgba(32,76,237,0.06)] hover:border-primary/40"
