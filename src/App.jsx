...
import { AssessmentPage } from "@/pages/experience/Assessment";
import { RecommendationPage } from "@/pages/experience/Recommendation";
...
import { ProgressTrackingPage } from "@/pages/admin/ProgressTracking";
import { GrantAccessPage } from "@/pages/admin/GrantAccess";
import { StoriesAdminPage } from "@/pages/admin/StoriesAdmin";
    ...
    <BrowserRouter>
      <MobileGate>
        ...
        <Routes>
          ...
          <Route
            path="/experience/:productSlug/assessment"
            element={
              <RequireExperienceAuth>
                <AssessmentPage />
              </RequireExperienceAuth>
          ...
          />
          <Route
            path="/experience/:productSlug/recommendation"
            element={
              <RequireExperienceAuth>
                <RecommendationPage />
              </RequireExperienceAuth>
          ...
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="stories/:id" element={<StoryFormPage />} />
